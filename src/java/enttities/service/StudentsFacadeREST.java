 ...
 */
package enttities.service;

import enttities.Students;
 ...
 */
@Stateless
@Path("enttities.students")
public class StudentsFacadeREST extends AbstractFacade<Students> {

    @PersistenceContext(unitName = "WIT_WebAppPU")
    ...
    @GET
    @Path("/findCourse/{course}")
    @Produces({MediaType.APPLICATION_XML,MediaType.APPLICATION_JSON})
    public Students findCourse(@PathParam("course")String c){
        return super.findCourse(c);
    }
